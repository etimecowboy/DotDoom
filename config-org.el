...
(after! org
  (setq org-after-todo-state-change-hook
        ...
        org-columns-default-format "%CATEGORY(Cat.) %PRIORITY(Pri.) %6TODO(State) %35ITEM(Details) %ALLTAGS(Tags) %5NUM_POMODORO(Plan){:} %6CLOCKSUM(Clock){Total} %SCORE(SCORE)"
        ...
        org-format-latex-options '(:foreground default
                                   ...
                                   :html-scale 2.0
                                   :matchers ("begin" "$1" "$" "$$" "\\(" "\\["))
        org-global-properties '(("POMODORO_ALL" . "0 1 2 3 4 5")
        ...
        '((:startgrouptag) ("PROJECT" . 80) ("AREA" . 65) ("RESOURCE" . 82) ("ARCHIVE" . 90) (:endgrouptag)
          (:startgrouptag) ("CONFIDENTIAL" . 67) ("FLAGGED" . 70) ("ATTACH" . 84) (:endgrouptag)
          (:startgrouptag) ("glossary" . 103) ("reference" . 114) ("literature" . 108) ("fleeting" . 102) ("permanent" . 112) ("code" . 99) ("hub" . 104) ("publication" . 98) ("vocabulary" . 118) (:endgrouptag)
          (:startgrouptag) ("noexport" . 110) ("TOC" . 79) ("repeat" . 114) (:endgrouptag)
          (:startgrouptag) ("action" . 116) ("hidden" . 104) ("status" . 115) (:endgrouptag))
        org-todo-keywords
        ...
        org-use-tag-inheritance '("fleeting" "AREA" "RESOURCE"
                                  "ARCHIVE" "action" "status" "hidden"
                                  "publication" "code" "vocabulary" "ATTACH")
        )
  )
...
(after! org-contacts
  (setq org-contacts-files
        '(
          (concat org-roam-directory "contacts.org.gpg")
          )
        )
  )
...
(after! ob
  ...
  ;; (doom-require 'ob-sqlite)
  ;; (doom-require 'ob-latex)
  ;; (doom-require 'ob-ditaa)
...
(after! org-roam
  (setq org-roam-capture-ref-templates
        ...
        '(("d" "fleeting (default)" entry "* NEW %^{title}    :fleeting:\12:LOGBOOK:\12- Create time: %U\12- From: %a\12- Tags: [ add reference notes ]\12- See also: [ add fleeting and permanent notes ]\12- Areas: [ add areas-of-responsibility ]\12:END:"
  ...
  ;;(org-roam-db-autosync-mode +1) ;; It is turned on by :lang org module by default
  )
